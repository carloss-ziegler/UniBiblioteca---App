...
const Authentication = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Text style={{ fontWeight: "700", fontSize: 20, color: "#222831" }}>
          Bem-Vindo(a)!
        </Text>
        ...
        >
          <Text style={{ color: "#7c7c7c", fontSize: 16, fontWeight: "600" }}>
          ...
          >
            <Text style={{ color: "#f6f5f5", fontWeight: "600", fontSize: 20 }}>
              Entrar
            </Text>
          </TouchableOpacity>
        </View>
